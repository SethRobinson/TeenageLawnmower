...
#include "d3dx8math.h" //for the vector3 stuff
...
public:
	...
	D3DXVECTOR3 * GetVector3(){return  ((D3DXVECTOR3*)m_p_extra);}
	void SetVector3(D3DXVECTOR3 *p_vec){*((D3DXVECTOR3*)m_p_extra) = *((D3DXVECTOR3*)p_vec); }
