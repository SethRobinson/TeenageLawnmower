...
{
    if (i_error == WSAEWOULDBLOCK) log_msg("Winsock Error: WSAEWOULDBLOCK");
    else
    if (i_error == WSAEINPROGRESS) log_msg("Winsock Error: WSAEINPROGRESS");
    else
    if (i_error == WSAEALREADY) log_msg("Winsock Error: WSAEALREADY");
    else
    if (i_error == WSAENOTSOCK) log_msg("Winsock Error: WSAENOTSOCK");
    else
    if (i_error == WSAEDESTADDRREQ) log_msg("Winsock Error: WSAEDESTADDRREQ");
    else
    if (i_error == WSAEMSGSIZE) log_msg("Winsock Error: WSAEMSGSIZE");
    else
    if (i_error == WSAEPROTOTYPE ) log_msg("Winsock Error: WSAEPROTOTYPE");
    else
    if (i_error == WSAENOPROTOOPT) log_msg("Winsock Error:WSAENOPROTOOP");
    else
    if (i_error == WSAEPROTONOSUPPORT) log_msg("Winsock Error: WSAEPROTONOSUPPORT");
    else
    if (i_error == WSAESOCKTNOSUPPORT ) log_msg("Winsock Error: WSAESOCKTNOSUPPORT");
    else
    if (i_error == WSAEOPNOTSUPP) log_msg("Winsock Error: WSAEOPNOTSUPP");

    else  log_msg("Winsock Error: Unknown.");
